...
describe('admin routes', () => {
  it.each<RouteCase>([
    ...
    { name: 'POST /admin/pages/:id', method: 'POST', path: '/admin/pages/101', body: form({ name: 'About Updated', slug: 'about-updated', page_type: 'default', weight: '3' }), authenticated: true, expectedStatus: 302, location: '/admin/pages/101/edit?language=en&flash=Page+updated+successfully' },

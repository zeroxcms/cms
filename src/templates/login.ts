    ...
    <div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-blue-100 px-4">
      <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-xl p-8">
          ${errorBanner}
          <a href="/auth/start"
             class="flex items-center justify-center gap-3 w-full px-4 py-3 rounded-xl border-2 border-gray-200 text-gray-700 font-semibold hover:border-indigo-400 hover:bg-indigo-50 transition-all duration-150 group">
            <span class="text-gray-600 group-hover:text-indigo-600 transition-colors">${providerIcon}</span>
